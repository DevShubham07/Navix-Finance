...
/**
 * Borrower contact lookup for the notification engine — resolves an applicant's latest known name +
...
public interface BorrowerContactDirectory {
    ...
    /** Contact details for a borrower by applicant id, or empty if no profile is known. */
    Optional<ContactInfo> borrowerContact(Long applicantId);
}
