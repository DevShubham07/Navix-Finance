...
public final class ApplicationDtos {
    ...
    public record ApplicationView(
        ...
        /**
         * Enriched with the applicant's staff-only credit headline (score + 1–5★ + verdict) so every
         * staff queue row shows it inline. {@code p} may be null (no profile / borrower-facing path).
         */
        public static ApplicationView of(LoanApplication a, ApplicantProfile p) {
