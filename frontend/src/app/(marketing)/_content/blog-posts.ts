...
//
// ⚠ YMYL content — reviewed for factual alignment with NAVIX (platform not lender; ₹5,000–₹10,00,000;
...
function page(p: {
  ...
  <div class="sec"><div class="wrap"><div class="prose" style="max-width:760px;margin:0 auto">
    ${p.body}
    <p style="margin-top:32px;font-size:.86rem;color:var(--muted)"><em>This article is general information, not financial advice. Loans are offered by NAVIX's RBI-registered NBFC partners; all rates and charges are set out in your Key Fact Statement before you accept an offer.</em></p>
...
export const POSTS: Record<string, BlogPost> = {
  "how-to-read-a-kfs": {
    ...
    <p>The Key Fact Statement (KFS) is a short, standardised summary that every regulated lender in India must give you before you accept a loan. It exists so you can see the real cost of borrowing in one place, in plain terms, without hunting through pages of legal text. On NAVIX, the KFS is issued by the partner NBFC — the lender of record — and you receive it before you e-sign anything.</p>
    <h2>Which numbers actually matter?</h2>
    <p>Five figures do most of the work:</p>
    <ul>
      <li><b>Loan amount (principal):</b> the amount sanctioned to you — on NAVIX, anywhere from ₹5,000 to ₹10,00,000.</li>
      <li><b>Interest rate:</b> how the interest is calculated. NAVIX loans use a simple 1% per day on the principal, over your actual tenure.</li>
    ...
    <ul>
      ...
      <li>Are there <b>zero advance fees</b>? (There should be — NAVIX never charges one.)</li>
      <li>Are the <b>prepayment terms</b> clear? (NAVIX has no pre-closure charges.)</li>
    </ul>
  ...
  "signs-of-a-loan-scam": {
    ...
    <p>This is the single biggest red flag. Legitimate lenders never ask you to pay a fee <em>before</em> disbursal. On NAVIX, fees are netted from your disbursal and disclosed in the Key Fact Statement — you never send money to receive a loan. If anyone demands an upfront payment to "release", "unlock" or "insure" your loan, stop.</p>
    ...
    <p>Scammers clone brand names and logos. Always check you're on the official domain — for us, that's <b>navixfinance.com</b> — and that emails come from <b>info@navixfinance.com</b>. Be wary of loan offers arriving by random WhatsApp, SMS or Telegram links, or apps downloaded from outside official stores.</p>
    <h2>4. There's no clear lender or registration</h2>
    <p>Every legitimate loan in India is made by an RBI-registered entity. If you can't tell who the actual lender is, or there's no Key Fact Statement, walk away. NAVIX is a platform; the loan is sanctioned and disbursed by our RBI-registered NBFC partners, and that's stated clearly before you sign.</p>
    ...
    <ul>
      ...
      <li>Report anything suspicious in NAVIX's name to <b>info@navixfinance.com</b>.</li>
    </ul>
  ...
  "what-affects-your-credit-score": {
    ...
    <p>Paying on time, every time, is the strongest thing you can do. A single missed or late payment can dent your score, and the effect lingers. Set reminders, automate where you can, and if you're going to be late, talk to your lender early. On NAVIX, your due date is salary-linked and shown clearly, precisely so it's easy to pay on time.</p>
  ...
  "when-a-short-term-loan-makes-sense": {
    ...
    <p>Approval for a limit is not an instruction to use all of it. Borrow the smallest amount that solves your problem, over the shortest sensible tenure. On NAVIX you can see the exact repayment for any amount on the calculator before you commit — use it to find the number that's comfortable, not just possible.</p>
  ...
  "repaying-on-navix": {
    slug: "repaying-on-navix",
    title: "Repaying on NAVIX: UPI, net-banking & auto-debit",
    description:
      "Every way to repay your NAVIX loan — UPI, net-banking and auto-debit — plus how repaying early saves you interest.",
    category: "Product",
    readMin: 3,
    date: "Apr 2026",
    ...
    <p>A NAVIX loan is designed to be simple: you repay it in a <b>single instalment</b> on or after your salary date. There are no EMIs to track. Your exact due date and total amount are shown in your Key Fact Statement and on your dashboard, so you always know what's due and when.</p>
    ...
    <p>NAVIX charges 1% per day on the principal over the actual tenure, and there are <b>no pre-closure or prepayment charges</b>. That means clearing your loan early genuinely reduces what you pay — you're only charged interest for the days you actually held the loan. If salary lands early, paying early is a small, easy win.</p>
    <h2>If you might miss the date</h2>
    <p>Life happens. If you think you'll be late, contact us early at <b>info@navixfinance.com</b>. A late payment attracts a fee of 2% per day on the overdue principal (capped at 30 days) and can affect your credit score, so it's always worth talking to us before the date rather than after.</p>
