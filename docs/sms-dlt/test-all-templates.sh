...
"DHANBOOST_KYC_APPROVED_V1|||${DHANBOOST_DLT_KYC_APPROVED:-}|||Your KYC is verified with DhanBoost. Log in at https://www.dhanboost.com/login to choose your loan amount. - DhanBoost"
"DHANBOOST_KYC_REJECTED_V1|||${DHANBOOST_DLT_KYC_REJECTED:-}|||We could not verify your KYC with DhanBoost. Log in at https://www.dhanboost.com/login to review and resubmit. - DhanBoost"
"DHANBOOST_KYC_REMINDER_V1|||${DHANBOOST_DLT_KYC_REMINDER:-}|||Your verification with DhanBoost is incomplete. Log in at https://www.dhanboost.com/login to complete your pending steps. - DhanBoost"
"DHANBOOST_LOAN_DISBURSED_V1|||${DHANBOOST_DLT_LOAN_DISBURSED:-}|||DhanBoost has disbursed Rs. 8,820 to your bank account. Repay Rs. 12,700 by 30 Jun 2026 at https://www.dhanboost.com/login. - DhanBoost"
"DHANBOOST_REPAYMENT_VERIFIED_V1|||${DHANBOOST_DLT_REPAYMENT_VERIFIED:-}|||Your payment of Rs. 5,000 to DhanBoost is confirmed. Outstanding balance is Rs. 7,700. View details at https://www.dhanboost.com/login. - DhanBoost"
"DHANBOOST_REPAYMENT_REJECTED_V1|||${DHANBOOST_DLT_REPAYMENT_REJECTED:-}|||Your payment of Rs. 5,000 could not be verified by DhanBoost. Log in at https://www.dhanboost.com/login to check the reference and record it again. - DhanBoost"
"DHANBOOST_PAYMENT_DUE_SOON_V1|||${DHANBOOST_DLT_PAYMENT_DUE_SOON:-}|||Your DhanBoost payment of Rs. 12,700 is due in 3 day(s) by 30 Jun 2026. Pay at https://www.dhanboost.com/login on or after your salary day with no penalty. - DhanBoost"
"DHANBOOST_PAYMENT_OVERDUE_V1|||${DHANBOOST_DLT_PAYMENT_OVERDUE:-}|||Your DhanBoost payment of Rs. 12,700 is overdue by 5 day(s). Pay now at https://www.dhanboost.com/login to stop the daily penalty and protect your credit score. - DhanBoost"
"DHANBOOST_LOAN_CLOSED_V1|||${DHANBOOST_DLT_LOAN_CLOSED:-}|||Your loan with DhanBoost is fully repaid and closed. Thank you. Visit https://www.dhanboost.com/login to borrow again. - DhanBoost"
"DHANBOOST_APPLICATION_DECLINED_V1|||${DHANBOOST_DLT_APPLICATION_DECLINED:-}|||DhanBoost is unable to approve your loan application at this time. Visit https://www.dhanboost.com/login for details. - DhanBoost"
"DHANBOOST_SETTLEMENT_APPROVED_V1|||${DHANBOOST_DLT_SETTLEMENT_APPROVED:-}|||A full and final settlement of Rs. 9,000 is approved on your DhanBoost loan. Pay at https://www.dhanboost.com/login to close the loan. - DhanBoost"
"DHANBOOST_REBORROW_APPROVED_V1|||${DHANBOOST_DLT_REBORROW_APPROVED:-}|||Your loan application with DhanBoost is approved. Log in at https://www.dhanboost.com/login to choose your amount. - DhanBoost"
"DHANBOOST_REBORROW_PREAPPROVED_V1|||${DHANBOOST_DLT_REBORROW_PREAPPROVED:-}|||Welcome back to DhanBoost. You can apply for another loan now. Log in at https://www.dhanboost.com/login to choose your amount. - DhanBoost"
"DHANBOOST_REFERRAL_REWARD_CREDITED_V1|||${DHANBOOST_DLT_REFERRAL_REWARD_CREDITED:-}|||Your DhanBoost referral reward of Rs. 500 is credited with reference TXN123456. Log in at https://www.dhanboost.com/login to view it. - DhanBoost"
)
