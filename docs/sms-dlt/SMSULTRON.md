...
Destination: https://ultronsms.com/Web/MT/MyTemplate.aspx (fill runbook: ULTRON_FILL_RUNBOOK.md)
Sender ID (all templates): DHANBT
PE-ID (entity-level, constant): 1701178039634361131
Total templates: 15 — status as of 2026-08-01: ALL 15 Active, DLT ids assigned (below).
...
The _V1 ids below are the live ones (collected off the portal 2026-08-01, all 15 Active).
...
STATUS LEGEND
-----------------------------------------------------
[ACTIVE]  approved by STPL, content frozen — do NOT edit these bodies. 6 were approved 2026-07-31;
          the other 9 were rejected that day for sounding promotional, rewritten ("Dear <name>,"
          opener + the borrower's own application/loan id + no invitation to transact), re-submitted
          2026-08-01 and approved. Details in DLT_SUBMISSION_TRACKER.md.

-------------------------------------------------------
1. Template Name: DHANBOOST_OTP_LOGIN_V1                             [ACTIVE]
   DLT Template ID: 1777178551180955540
   Content: Your OTP for DhanBoost login is ##Field##. It is valid for ##Field## minutes. Do not share this OTP with anyone. - DhanBoost

2. Template Name: DHANBOOST_KYC_APPROVED_V1                          [ACTIVE]
   DLT Template ID: 1777178556860826081
...
3. Template Name: DHANBOOST_KYC_REJECTED_V1                          [ACTIVE]
   DLT Template ID: 1777178556856596751
...
4. Template Name: DHANBOOST_KYC_REMINDER_V1                          [ACTIVE]
   DLT Template ID: 1777178556869196458
...
5. Template Name: DHANBOOST_LOAN_DISBURSED_V1                        [ACTIVE]
   DLT Template ID: 1777178556842056405
...
6. Template Name: DHANBOOST_REPAYMENT_VERIFIED_V1                    [ACTIVE]
   DLT Template ID: 1777178551212221383
...
7. Template Name: DHANBOOST_REPAYMENT_REJECTED_V1                    [ACTIVE]
   DLT Template ID: 1777178551218012610
...
8. Template Name: DHANBOOST_PAYMENT_DUE_SOON_V1                      [ACTIVE]
   DLT Template ID: 1777178556822213797
...
9. Template Name: DHANBOOST_PAYMENT_OVERDUE_V1                       [ACTIVE]
   DLT Template ID: 1777178556852586580
...
10. Template Name: DHANBOOST_LOAN_CLOSED_V1                          [ACTIVE]
    DLT Template ID: 1777178551234723180
...
11. Template Name: DHANBOOST_APPLICATION_DECLINED_V1                 [ACTIVE]
    DLT Template ID: 1777178556864993650
...
12. Template Name: DHANBOOST_SETTLEMENT_APPROVED_V1                  [ACTIVE]
    DLT Template ID: 1777178556848308137
...
13. Template Name: DHANBOOST_REBORROW_APPROVED_V1                    [ACTIVE]
    DLT Template ID: 1777178556873259005
...
14. Template Name: DHANBOOST_REBORROW_PREAPPROVED_V1                 [ACTIVE, registered PROMOTIONAL]
    DLT Template ID: 1777178551273887503
...
15. Template Name: DHANBOOST_REFERRAL_REWARD_CREDITED_V1             [ACTIVE, registered PROMOTIONAL]
    DLT Template ID: 1777178551284965972
